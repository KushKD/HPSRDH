...
public class UserPojo implements Serializable {
    ...
    private String Res_Gauardian_User;
    private String res_addr_subdistrict_name_User;
    private String res_addr_po_name_User;

    public String getRes_addr_po_name_User() {
        return res_addr_po_name_User;
    }

    public void setRes_addr_po_name_User(String res_addr_po_name_User) {
        this.res_addr_po_name_User = res_addr_po_name_User;
    }
    ...
    public String getRes_Gauardian_User() {
        return Res_Gauardian_User;
    }

    public void setRes_Gauardian_User(String res_Gauardian_User) {
        Res_Gauardian_User = res_Gauardian_User;
    }

    public String getRes_addr_subdistrict_name_User() {
        return res_addr_subdistrict_name_User;
    }

    public void setRes_addr_subdistrict_name_User(String res_addr_subdistrict_name_User) {
        this.res_addr_subdistrict_name_User = res_addr_subdistrict_name_User;
    }
