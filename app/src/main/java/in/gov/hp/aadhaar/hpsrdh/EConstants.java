...
public  class EConstants {
    ...
    public static final String url_Generic_Search = "" ;
    public static final String methord_Login = "";
    public static final String methord_Logout = "";
    public static final String methord_SearchEID = "";
    ...
    public static final String UserResultFiveP = "";
    public static final String UserResultFourP ="";
    public static final String UserResultAadhaarSearch = "";
    public static final String UserResultEIDSearch ="";
   ...
   //Five Parameters
    ...
    public static final String FH4 ="";
    public static final String DOB4 = "";
